...
{
    public class V2_Flood : EnvironmentDisaster
    {
        ...
        {
            IsRunning = true;
            _effectObject = new GameObject("V2_Flood_Effect");
            _effectObject.AddComponent<ParticleSystem>();
            Debug.Log($"[V2_Flood] {Params.Name} 开始 (DPS={Params.BaseDPS})");
        }
